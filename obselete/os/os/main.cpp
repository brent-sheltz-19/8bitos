...
static ram bank3 = ram(&port,&addreg,rwpin,0x6000u);// driver ram
static ram bank4 = ram(&port,&addreg,rwpin,0x8000u);// driver ram

static ram bank5 = ram(&port,&addreg,rwpin,0xA000u);// driver ram
static ram bank6 = ram(&port,&addreg,rwpin,0xC000u);// driver ram
